      ...
      <div className="db__results_summary"> 
        <div className="db__results_summary_inner">
          <div className="db__summary_output">
            ...
            <h3><span class="highlight">{tallies.resultsNum}</span> result{tallies.resultsNum != '1' ? 's' : '' } for <span class="highlight">{tallies.granteesNum}</span> grantee{tallies.granteesNum != '1' ? 's' : '' } totaling <br/><span class="highlight font-large">${tallies.grantsTotal}</span></h3>
